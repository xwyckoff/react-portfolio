...
export default function AboutMeCard(props) {
    return (
        <main className='flex justify-center'>
            <div className="--card-div lg:flex lg:justify-around xl:w-2/4 sm:h-full m-10 xl:m-0 rounded-lg p-4 bg-brand-secondary backdrop-blur-md bg-opacity-50 gap-7 shadow-lg">
                <div>
                    <Image
                        className='rounded-full lg:object-scale-down'
                ...
                <div className='xl:text-xl md:text-md'>
